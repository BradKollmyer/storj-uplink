//! Single-segment upload: inline (≤ 4 KiB encrypted) vs one remote segment.
...
pub fn prepare_segment(
    ...
    let kind = if is_inline(&inline_data) {
        ...
        let scheme = scheme
            .ok_or_else(|| crate::Error::protocol("remote segment missing redundancy scheme"))?;
