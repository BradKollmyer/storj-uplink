...
//! Depend on `storj` instead. Identity is ephemeral ECDSA P-256; rustls pins
//! the peer NodeID (no WebPKI).
...
pub use frame::{
    DRPC_TLS_MUX_PREFIX, Frame, FrameError, Kind, Packet, PacketAssembler, append_frame,
    append_packet, marshal_error, parse_frame,
};
